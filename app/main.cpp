 ...
 * The code takes in initial and target velocities from the user and for time step of 0.1 sec the program calculates the error and uses the PID controller to increase its velocity until the target velocity is reached.
 * @version 0.1
 * @date 2021-10-02
 * 
...
int main() {
    ...
    std::cout << "The new velocity is : " << pid.get_goal_velocity() <<
    std::endl;
